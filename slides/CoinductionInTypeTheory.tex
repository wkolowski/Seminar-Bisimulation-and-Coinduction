...
\begin{itemize}
  ...
  \item These slides are a shortened version of \url{https://github.com/wkolowski/Seminar-Bisimulation-and-Coinduction/blob/master/slides/TalkSlides.pdf} -- see there for a critique of other approaches to coinduction and for an interesting connection between coinduction and topology.
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item The code snippet with the example is available from the GitHub repo of this talk: \url{https://github.com/wkolowski/Seminar-Bisimulation-and-Coinduction/blob/master/src/Duality.v} (beware: no comments in the code).
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \item As our running example of $C$, we will use $\texttt{conat}$, the conatural numbers (see \href{https://github.com/wkolowski/Seminar-Bisimulation-and-Coinduction/blob/master/src/Duality.v}{\color{blue}{here}} for the definition).
...
\begin{frame}{Snippet}
\begin{itemize}
	\item Code snippets that illustrate how schematic definitions are side-effecting and how the definitions of \texttt{W} and \texttt{M} look like can be found in the file \url{https://github.com/wkolowski/Seminar-Bisimulation-and-Coinduction/blob/master/src/SchematicWM.v}.
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item As an exercise, try to develop the theory of conatural numbers: \url{https://github.com/wkolowski/Seminar-Bisimulation-and-Coinduction/blob/master/src/ConaturalExercises.v}.
\end{itemize}
\end{frame}
