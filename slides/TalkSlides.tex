...
\begin{itemize}
	...
	\item The code snippet with the example is available from the GitHub repo of this talk: \url{https://github.com/wkolowski/Seminar-Bisimulation-and-Coinduction/blob/master/src/Duality.v}
\end{itemize}
\end{frame}
...
\begin{itemize}
	...
	\item The snippet with a Coq proof of their searchability is \url{https://github.com/wkolowski/Seminar-Bisimulation-and-Coinduction/blob/master/src/Searchability.v}.
...
\begin{itemize}
	\item Ex. 1: is it possible to prove the searchability of conaturals without using the axiom \texttt{sim\_eq}?
